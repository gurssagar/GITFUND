                    ...
                    <div className="container mx-auto px-6 py-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div className="rounded-lg shadow-md p-6 bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-dark dark:text-white relative">
                                <h3 className="text-sm font-medium text-neutral-100">Rewarded amount</h3>
                                <p className="text-3xl font-semibold text-white mt-1">{totalRewarded.toFixed(4)} Pharos</p>
                            ...
                            <div className="rounded-lg shadow-md p-6 bg-neutral-50 dark:bg-neutral-800  relative">
                                <h3 className="text-sm font-medium text-neutral-400">Paid</h3>
                                <p className="text-3xl font-semibold mt-1 text-dark dark:text-dark dark:text-white">{totalRewarded.toFixed(4)} Pharos</p>
                                 <button className="absolute bottom-4 right-4 text-neutral-400 hover:text-dark dark:text-white">
                            ...
                            <div className="rounded-lg shadow-md p-6 bg-neutral-50 dark:bg-neutral-800 ">
                                <h3 className="text-sm font-medium text-neutral-400 mb-3">Rewards Charts</h3>
                                    ...
                                    {(() => {
                                        ...
                                        return months.map((month, i) => (
                                            <div key={month + i} className="text-center">
                                                <div
                                                    className="w-4 bg-neutral-600 rounded-t mx-auto"
                                                    style={{
                                                ...
                                                ></div>
                                                <span className="text-xs text-neutral-500 mt-1 block">{month}</span>
                                            </div>
                                        ));
                                    })()}
                                </div>
                        ...
                        <div className="flex items-center justify-between mb-4 bg-neutral-50 dark:bg-neutral-800  p-3 rounded-lg">
                            <div className="flex items-center space-x-3">
                                <button className="p-2 rounded text-neutral-400 hover:bg-neutral-700 hover:text-dark dark:text-white">
                                ...
                                <div className="relative">
                                    ...
                                    <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-neutral-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                                    </span>
                                    <input
                                        type="text"
                                        placeholder="Search"
                                        ...
                                        className="bg-neutral-300 dark:bg-neutral-700 text-dark dark:text-white placeholder-neutral-500 rounded-md py-2 pl-10 pr-4 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    />
                                </div>
                            </div>
                            <button className="p-2 rounded text-neutral-400 hover:bg-neutral-300 dark:hover:bg-neutral-700 hover:text-dark dark:text-white">
                        ...
                        {/* Rewards Table */}
                        <div className="overflow-x-auto bg-neutral-50 dark:bg-neutral-800  rounded-lg shadow">
                            <table className="min-w-full divide-y divide-neutral-700">
                                <thead className="bg-neutral-50 dark:bg-neutral-800 ">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-400 uppercase tracking-wider">Project</th>
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-400 uppercase tracking-wider">From</th>
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-400 uppercase tracking-wider">Contributions</th>
                                ...
                                <tbody className="bg-neutral-50 dark:bg-neutral-800  divide-y divide-neutral-700">
                                    {loading && (
                                        <tr><td colSpan={7} className="text-center py-4 text-neutral-500">Loading...</td></tr>
                                    )}
                                    {error && (
                                        <tr><td colSpan={7} className="text-center py-4 text-red-500">Error: {error}</td></tr>
                                    )}
                                    {!loading && !error && filteredRewards.length === 0 && (
                                        <tr><td colSpan={7} className="text-center py-10 text-neutral-500">No items found.</td></tr>
                                    )}
                                    {!loading && !error && filteredRewards.map((reward) => (
                                        <tr key={reward.id} className="hover:bg-neutral-100/50 dark:hover:bg-neutral-700/50">
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-dark dark:text-neutral-300">
