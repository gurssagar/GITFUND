        ...
        <div className='flex'>
            ...
            <div className='w-[85%]'>
                ...
                <div className='flex pt-16'>
                    ...
                    <div className='pt-3  text-center text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500 text-3xl font-bold'>
                        Start Contributing
                        </div>
                        <div className='text-center text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500 text-3xl font-bold'>
                            Begin Earning
                        </div>
                        <h4 className="text-center pt-4 text-gray-400 text-[15px]">
                        Get recommendations based on your profile and past contributions.
                        </h4>
                        <h4 className="text-center pt-2 text-gray-400 text-[15px]">
                        Didn’t find what you’re looking for?
                        </h4>

                        <div className='flex mt-4 space-x-5'>
                        <div className='p-4 w-1/2 rounded-xl border-gray-800 border-1'>
                ...
                <div className='mt-10 mx-4'>
                        <div>
                            <h1 className='pt-3 text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500 text-3xl font-bold'>Projects in your favorite languages </h1>
                            <p className='pt-2 text-gray-400 text-[15px]'>Discover projects that match the languages you love to code in.</p>
