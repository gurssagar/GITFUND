...
import { useAccount, useBalance } from 'wagmi'; // Added useAccount and useBalance
            ...
            >
                <div className="flex flex-col h-full justify-between"> 
                    <div> 
                        ...
                        <div>
                            ...
                            <div className='rounded-lg text-sm active:bg-gray-400 hover:bg-gray-100 dark:hover:bg-[#27272a] px-2 py-2 flex'>
                                <svg xmlns="http://www.w3.org/2000/svg" className='my-auto mr-2' width="20" height="20" viewBox="0 0 24 24">
                        ...
                        <div className='pt-7'>
                            {!isShrunk && <div className='text-[13px] text-gray-400 py-2'>Contributor</div>}
                            ...
                            <div className='rounded-lg text-sm data-[active=true]:bg-gray-400 hover:bg-gray-100 dark:hover:bg-[#27272a] px-2 py-2 flex'>
                                ...
                                <path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSSeoFolder0)"/></svg>
                                {!isShrunk && "Projects"}
                            </div>
                            </Link>
                            <a href="Rewards">
                            <div className='rounded-lg text-sm data-[active=true]:bg-gray-400 hover:bg-gray-100 dark:hover:bg-[#27272a] px-2 py-2 flex'>
                                <svg xmlns="http://www.w3.org/2000/svg" className='my-auto mr-2' width="20" height="20" viewBox="0 0 12 12">
                                <path fill="currentColor" d="M2.25 1C1.56 1 1 1.56 1 2.25v1.162a1.5 1.5 0 0 0 .772 1.31l2.876 1.599a3 3 0 1 0 2.704 0l2.877-1.598A1.5 1.5 0 0 0 11 3.412V2.25C11 1.56 10.44 1 9.75 1zM2 2.25A.25.25 0 0 1 2.25 2H4v2.817l-1.743-.968A.5.5 0 0 1 2 3.412zm3 3.122V2h2v3.372l-1 .556zm3-.555V2h1.75a.25.25 0 0 1 .25.25v1.162a.5.5 0 0 1-.257.437zM8 9a2 2 0 1 1-4 0a2 2 0 0 1 4 0"/></svg>
                                {!isShrunk && "Rewards"}
                            </div>
                            </a>
                        </div>
                        ...
                        </div> {/* End of wrapper for top content */}
                    ...
                    >
                        {isConnected ? (
                            isShrunk ? (
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="mx-auto"><path fill="currentColor" d="M20 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2m0 14H4V6h16zM6 10h8v2H6zm0 4h5v2H6z"/></svg>
                            ) : (
                                <>
                                <div onClick={() => {open}}>
