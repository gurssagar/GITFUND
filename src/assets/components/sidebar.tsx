...
export default function Sidebar() {
  ...
  <div
    className={
      ...
      "h-screen bg-white dark:bg-black border-r-[1px] dark:border-custom-dark-gray py-4 transition-all duration-400 ease-in-out"
    }
  ...
  >
    <div className="flex flex-col h-full justify-between">
              ...
              <div className="rounded-lg gap-2 text-sm focus:bg-gray-400 hover:bg-gray-100 dark:hover:bg-[#27272a] px-2 py-2 flex">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 48 48">
                  <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="4">
                    <path d="M37 44a4 4 0 1 0 0-8a4 4 0 0 0 0 8ZM11 12a4 4 0 1 0 0-8a4 4 0 0 0 0 8Zm0 32a4 4 0 1 0 0-8a4 4 0 0 0 0 8Z"/>
      ...
      <div className="flex-shrink-0 mt-4">
        <div
          onClick={() => open()}
          className="px-4 py-2 dark:bg-custom-dark-gray bg-gray-200 dark:text-white text-black rounded-lg cursor-pointer text-center"
        >
          {isConnected ? (
            isShrunk ? (
              <svg
