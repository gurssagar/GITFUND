...
export default function Sidebar() {
    return (
        ...
        <div className='w-[16rem] h-screen border-r-[1px] border-gray-800 px-4 py-4'>
                <Image src="/gitfund-white.webp" alt="Gitfund logo" width={100} height={100}></Image>
                <div>
                <div className='pt-7'>
                    <div className='text-[13px] text-gray-400 py-2'>Explore</div>
                    <Link href="/homepage">
                    <div className='rounded-lg text-sm focus:bg-gray-400 hover:bg-[#27272a] px-2 py-2 flex'>
                    ...
                    <div className='rounded-lg text-sm data-[active=true]:bg-gray-400 hover:bg-[#27272a] px-2 py-2 flex'>
                    ...
                    <div className='rounded-lg text-sm active:bg-gray-400 hover:bg-[#27272a] px-2 py-2 flex'><svg xmlns="http://www.w3.org/2000/svg" className='my-auto mr-2' width="20" height="20" viewBox="0 0 24 24">
                ...
                <div className='pt-7'>
                    ...
                    <div className='rounded-lg text-sm data-[active=true]:bg-gray-400 hover:bg-[#27272a] px-2 py-2 flex'><svg xmlns="http://www.w3.org/2000/svg" className='my-auto mr-2' width="20" height="20" viewBox="0 0 48 48"><defs><mask id="ipSSeoFolder0"><g fill="none" stroke-width="4"><path fill="#fff" stroke="#fff" stroke-linejoin="round" d="M5 8a2 2 0 0 1 2-2h12l5 6h17a2 2 0 0 1 2 2v26a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z"/>
                    ...
                    <div className='rounded-lg text-sm data-[active=true]:bg-gray-400 hover:bg-[#27272a] px-2 py-2 flex'><svg xmlns="http://www.w3.org/2000/svg" className='my-auto mr-2' width="20" height="20" viewBox="0 0 12 12">
